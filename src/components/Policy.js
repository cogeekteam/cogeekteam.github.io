...
function Policy(props) {
  return (
    <div className="container mb-5" style={{ paddingTop: 150 }}>
      <h1>Privacy Policy of Cogeek</h1>

      <p>Cogeek operates the cogeek.com website, which provides the SERVICE.</p>

      <p>
        This page is used to inform website visitors regarding our policies with
        the collection, use, and disclosure of Personal Information if anyone
        decided to use our Service, the cogeek.com website.
      </p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at cogeek.com, unless
