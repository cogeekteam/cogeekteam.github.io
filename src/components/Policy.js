...
function Policy(props) {
  return (
    <div className="container mb-5" style={{ paddingTop: 150 }}>
      ...
      <p>
        If You are under 18, please do not attempt to access or take in use our
        Services (if not explicitly otherwise stated in the relevant service) or
        send any information about yourself to Us. Cogeek will not knowingly
        collect Personal Information from anyone under the age of 18. If you are
        a minor in your country of residence, please seek parental consent
        before using the Services. If You believe that we might have any
        information from or about a child under the age of 18, please contact us
        at cogeek.contact@gmail.com
      </p>
