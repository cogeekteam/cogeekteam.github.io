...
function Condition(props) {
  return (
    <div className="container mb-5" style={{ paddingTop: 150 }}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Cogeek Team, 301, Mac Dinh Chi, Bien Hoa,
            Dong Nai 81000.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Cogeek, accessible from{" "}
            <a
              href="https://cogeekteam.github.io/"
      ...
      <ul>
        <li>By email: cogeek.contact@gmail.com</li>
      </ul>
    </div>
  );
}
